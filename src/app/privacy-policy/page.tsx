...
export const metadata = {
  ...
  description: 'ABC Tennis Ltd (AceStars Tennis) privacy policy. How we collect, process, and protect your personal data.',
}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="mb-4" style={{ color: '#676D82' }}>
              ABC Tennis Ltd (AceStars Tennis) is registered at Companies House with registered number 04414619.
            </p>
            <p className="mb-4" style={{ color: '#676D82' }}>
              Our purpose is to empower parents, schools and the wider community to raise healthy, happy kids.
            </p>
            <p className="mb-4" style={{ color: '#676D82' }}>
              ABC Tennis Ltd (AceStars Tennis) is a data controller for the purposes of data protection legislation as we process personal data. This notice is designed to give you information about how we process that data. Our duties in respect of personal data are very important to us and we are committed to using the personal data we hold in accordance with the law. Any queries should be directed to: <a href="mailto:acestarsbookings@gmail.com" style={{ color: '#F87D4D' }}>acestarsbookings@gmail.com</a> or by post to ABC Tennis Ltd (AceStars Tennis), 15 Camperdown House, Windsor, Berkshire SL4 3HQ.
            </p>
            <p className="mb-4" style={{ color: '#676D82' }}>
              This notice applies alongside any other information ABC Tennis Ltd (AceStars Tennis) may provide about a particular use of personal data, for example when collecting data via an online or paper form. The notice should be read in conjunction with our other policies and contracts which apply to you and which make reference to personal data. This includes any agreement or contract you have entered into with ABC Tennis Ltd (AceStars Tennis), our safeguarding, pastoral, health &amp; safety policies and IT policies.
            </p>
            <p className="mb-6" style={{ color: '#676D82' }}>
              ABC Tennis Ltd (AceStars Tennis) expects parents, schools, customers and other individuals using the digital services and facilities provided by its business partners to respect the personal data and privacy of all stakeholders.
            </p>

            <h2 className="text-2xl font-bold mb-4 mt-10" style={{ color: '#1E2333' }}>What Type Of Personal Data Does ABC Tennis Ltd (AceStars Tennis) Process?</h2>
            <p className="mb-4" style={{ color: '#676D82' }}>
              We process personal data about prospective, current and past: kids and their parents (which includes guardians and carers as well as anyone with parental responsibility for that child) that are involved with any aspect of ABC Tennis Ltd (AceStars Tennis) services, and volunteers, schools, suppliers, contractors and others connected with us that are helping develop and support ABC Tennis Ltd (AceStars Tennis) to raise healthy, happy kids.
            </p>
            <p className="mb-4" style={{ color: '#676D82' }}>
              The personal data we process takes different forms (it may be factual information, opinion, images or other recorded information) and the type of data processed will depend on your relationship with ABC Tennis Ltd (AceStars Tennis). Examples of the personal data we process include:
            </p>
            <ul className="list-disc pl-6 space-y-2 mb-6" style={{ color: '#676D82' }}>
              ...
              <li>In respect of those who access the services provided by any of ABC Tennis Ltd (AceStars Tennis)&apos;s businesses, images and video footage</li>
            ...
            <ul className="list-disc pl-6 space-y-2 mb-4" style={{ color: '#676D82' }}>
              ...
              <li>The promotion of ABC Tennis Ltd (AceStars Tennis) and its businesses including through its own websites, apps, publications and communications, including social media channels</li>
              <li>Obtaining appropriate professional advice and insurance for ABC Tennis Ltd (AceStars Tennis)</li>
              <li>Where specifically requested by the individuals concerned</li>
            </ul>
            <p className="mb-6" style={{ color: '#676D82' }}>
              In some situations, we have to carry out these processes in order to meet our legal obligations, whether they are imposed on us by law. In other situations, we have obtained the consent of the relevant individual to the particular processing of the data. ABC Tennis Ltd (AceStars Tennis) has determined that it has a legitimate interest in all of the remaining processes we conduct.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-2 mb-4" style={{ color: '#676D82' }}>
              <li>Require ABC Tennis Ltd (AceStars Tennis) to change incorrect or incomplete data</li>
              <li>Require ABC Tennis Ltd (AceStars Tennis) to delete your data</li>
              <li>Withdraw your consent to ABC Tennis Ltd (AceStars Tennis) processing certain personal data where ABC Tennis Ltd (AceStars Tennis) is relying on your consent to do so</li>
              <li>Object to ABC Tennis Ltd (AceStars Tennis) processing your data where we are relying on our legitimate interests to do so</li>
              <li>Require ABC Tennis Ltd (AceStars Tennis) to transfer your personal data to another organisation</li>
              <li>Access and obtain a copy of your data on request</li>
            </ul>
            <p className="mb-6" style={{ color: '#676D82' }}>
              If you would like to exercise any of these rights, please contact us by email at <a href="mailto:acestarsbookings@gmail.com" style={{ color: '#F87D4D' }}>acestarsbookings@gmail.com</a> or by post at ABC Tennis Ltd (AceStars Tennis), 15 Camperdown House, Windsor, Berkshire SL4 3HQ. We will respond to such written requests as soon as is reasonably practicable and in any event within the time limits permitted by law. ABC Tennis Ltd (AceStars Tennis) will be better able to respond quickly to smaller, targeted requests for information.
            </p>
            ...
            <p className="mb-4" style={{ color: '#676D82' }}>
              ABC Tennis Ltd (AceStars Tennis) will update this notice from time to time. Any substantial changes that affect your rights will be notified on our website and, as far as reasonably practicable, notified to you.
            </p>
            <p className="mb-6" style={{ color: '#676D82' }}>
              If you believe that ABC Tennis Ltd (AceStars Tennis) has not complied with this notice or acted other than in accordance with data protection laws, you should notify ABC Tennis Ltd (AceStars Tennis) immediately. You can also make a referral to or lodge a complaint with the Information Commissioner&apos;s Office (ICO), although the ICO recommends that steps are taken to resolve the matter with ABC Tennis Ltd (AceStars Tennis) before involving the regulator.
            </p>
